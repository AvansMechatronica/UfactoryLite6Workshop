...
def morphological_transformations(im_thresh, morpho_type=MorphoType.CLOSE, kernel_shape=(5, 5),
    ...
    return cv2.morphologyEx(im_thresh, morpho_type, kernel)
...
def extract_img_workspace(img, workspace_ratio=1.0):
    ...
    result, im_cut = extract_img_markers(img, workspace_ratio)
    #cv2.imshow("Crop", im_cut)
    return im_cut
